...
public class DetailProjectPanel extends JPanel implements GTDInboxExceptionHandler {
    ...
    public void setProject(final Project project) throws DataBaseManagerException {
        ...
        DataBaseManager.getInstance().getEntityManager().refresh(this.project);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panelMain.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(3, 1, new Insets(0, 0, 0, 0), -1, 8));
