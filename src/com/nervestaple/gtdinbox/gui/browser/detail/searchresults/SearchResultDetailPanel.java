...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        scrollPaneResults.setFont( new Font( scrollPaneResults.getFont().getName(), scrollPaneResults.getFont().getStyle(), scrollPaneResults.getFont().getSize() ) );
        ...
        tableResults.setFont( new Font( tableResults.getFont().getName(), tableResults.getFont().getStyle(), 11 ) );
